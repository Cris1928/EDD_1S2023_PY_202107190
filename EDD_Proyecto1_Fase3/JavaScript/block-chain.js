...
class BlockChain{
    ...
    getMessages(transmitter, receiver){
        if(this.head !== null){
            let msgs = "";
            let temp = this.head;
           // window.listaPersonas.agregarAlinicio(new chat(temp.index, temp.getFormatDate(), temp.transmitter, temp.receiver, temp.message,temp.previusHash,temp.hash));
            while(temp !== null){
    ...
    llenar(){
        ...
        if(this.head){
            ...
            while(temp !== null){
                ...
                window.listaPersonas.agregarAlfinal(new chat(temp.index, temp.getFormatDate(), temp.transmitter, temp.receiver, temp.message,temp.previusHash,temp.hash));
                      temp = temp.next;
